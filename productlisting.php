            ...
            <div class="text-center d-flex justify-content-center" style="width:100;">
                <div style="position: relative;" class="col-lg-4 d-flex justify-content-center">
                    <div class="card text-center" style="min-height:45rem; max-width: 30rem;">
                        ...
                        <section class="lead p-2">
                            <p>Our flagship and most suitable tiered bundle. It come with the following products:</p>
                        ...
                        <a style="position: absolute; bottom: 0; width:100%;" href="prod_desc_tier1.php" type="button"
                            class="rounded-0 btn btn-danger py-2">Learn more
                        </a>
                    </div>
                </div>
                ...
                <div style="position: relative;" class="col-lg-4 d-flex justify-content-center">
                    <div class="card text-center" style="min-height:45rem; max-width: 30rem;">
                        ...
                        <section class="lead p-2">
                            <p>Tier 2 is most suitable for a small family. It come with the following products:</p>
                        ...
                        <a style="position: absolute; bottom: 0; width:100%;" href="prod_desc_tier2.php" type="button"
                            class="rounded-0 btn btn-danger py-2">Learn more</a>
                    </div>
                </div>
                ...
                <div style="position: relative;" class="col-lg-4 d-flex justify-content-center">
                    <div class="card text-center" style="min-height:45rem; max-width: 30rem;">
                        ...
                        <section class="lead p-2">
                            <p>This tier is the most cost-effective choice for large families. . It come with the
                        ...
                        <a style="position: absolute; bottom: 0; width:100%;" href="prod_desc_tier3.php" type="button"
                            class="rounded-0 btn btn-danger py-2">Learn more</a>
                    </div>
                </div>
