...
<div class="container-fluid">
	<div class="row">
		<div class="col-sm">
			<img src="./image/tier1.jpg" alt="Tier 1 Bundle Image" class="img-fluid">
				<h3>Tier 1</h3>
			...
			<div class="col-sm">
			<img src="./image/tier2.jpg" alt="Tier 2 Bundle Image" class="img-fluid">
				<h3>Tier 2</h3>
			...
			<div class="col-sm">
			<img src="./image/tier3.jpg" alt="Tier 3 Bundle Image" class="img-fluid">
				<h3>Tier 3</h3>
